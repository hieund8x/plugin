...
(function($){
	...
	$.fn.socialTrafficPop = function(options){
			...
			var defaults = {
				...
				// Configure Facebook
				fb_url: "http://codecanyon.net/item/social-traffic-pop-for-wordpress/309705",
				fb_layout: "button_count",
				fb_showfaces: false,
				fb_color_scheme: 'light',
				// Configure Twitter
				twitter_user: "TylerColwell7",
			...
			getPopHTML = function(){
				...
				if(defaults.facebook_on == true){
					...
					services = services + '<div class="stp-button"><fb:like href="'+defaults.fb_url+'" send="false" layout="'+defaults.fb_layout+'" width="50" show_faces="'+defaults.fb_showfaces+'" colorscheme="'+defaults.fb_color_scheme+'"></fb:like></div>';
				...
				if(defaults.google_on == true){
					...
					services = services + '<div class="stp-button"><g:plusone size="'+defaults.google_size+'" annotation="'+defaults.google_annotation+'" href="'+defaults.google_url+'" callback="googleCB"></g:plusone></div>';
				...
				var sPop = '<div id="stp-bg"></div><div id="stp-main"><div id="stp-title">'+spClose+''+defaults.title+'</div><div id="stp-msg">'+defaults.message+'</div><div id="stp-buttons">'+services+'<br class="step-clear" /></div><div id="stp-bottom"><div id="stp-counter">Share or wait <span id="stp-count"></span> seconds.<br /><a id="stp-power" href="http://goo.gl/iMdOz" title="Social Traffic Pop">Powered By STP</a></div></div></div>';
